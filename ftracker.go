// Пакет ftracker предназначен для отображения результатов тренировок.
//
// Этот пакет рассчитывает результаты тренировок (Бег, Ходьба, Плавание)
// и выводит информационное сообщение о результатах тренировок.
package ftracker
